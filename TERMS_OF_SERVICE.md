...
By accessing or using the Mepe Khai mobile application (the "App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

These Terms constitute a legally binding agreement between you and Sami Khan Fitness ("Company," "we," "us," or "our").

## 2. Description of Service

Mepe Khai is an AI-powered calorie and macro tracking application that provides:

- Food logging with AI-powered photo analysis
...
### Your Content
You retain all rights to the content you submit to the App, including:
...
### License to Us
By submitting content, you grant us a limited, non-exclusive, royalty-free license to:
...
- Is offensive, abusive, or harassing
...
**IMPORTANT: Mepe Khai is NOT a medical device and should NOT be used for medical purposes.**

### No Medical Advice
- The App provides general nutritional information and tracking tools
- The App does NOT provide medical, health, or dietary advice
- AI-generated nutritional estimates are approximations and may not be accurate
- Always consult with a qualified healthcare professional before making dietary changes

### Health Conditions
If you have any of the following, consult a doctor before using the App:
...
- Taking medications that affect diet or metabolism

### Limitations
- Calorie and macro calculations are estimates based on general formulas
- AI food analysis may be inaccurate
- The App cannot account for individual medical conditions
- Results may vary based on individual factors

### No Liability for Health Outcomes
We are not responsible for:
- Health outcomes resulting from use of the App
- Accuracy of nutritional information
- Decisions made based on App data
- Any adverse health effects

**IF YOU EXPERIENCE ANY ADVERSE HEALTH EFFECTS, STOP USING THE APP AND CONSULT A HEALTHCARE PROFESSIONAL IMMEDIATELY.**

## 8. Intellectual Property Rights

### Our Property
The App and its content (excluding user content) are owned by us and protected by:
- Copyright laws
- Trademark laws
...
### Current Status
The App is currently free to use. We reserve the right to introduce paid features or subscriptions in the future.

### Future Paid Features
If we introduce paid features:
- We will provide clear pricing information
- You will have the option to opt-in to paid features
- Separate payment terms will apply
- You may cancel subscriptions according to the cancellation policy
...
Some jurisdictions do not allow limitations on warranties or liability. In such cases, these limitations may not apply to you.

## 12. Indemnification

You agree to indemnify, defend, and hold harmless Mepe Khai, Sami Khan Fitness, and our affiliates, officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:

- Your use of the App
- Your violation of these Terms
- Your violation of any rights of another
- Your content submitted to the App
...
Key points:
- We collect personal and health data as described in the Privacy Policy
- We use industry-standard security measures
- Progress photos are stored locally on your device only
...
We will provide notice of material changes when possible, but are not obligated to do so.
...
### Survival
Provisions that should survive termination (including disclaimers, limitations of liability, and indemnification) will continue to apply.
...
BY USING MEPE KHAI, YOU ACKNOWLEDGE THAT:

- You have read and understood these Terms
- You agree to be bound by these Terms
- You understand the health disclaimers and limitations
...
*Thank you for using Mepe Khai. We're committed to helping you achieve your health and fitness goals while protecting your rights and privacy.*
